...
class RequestAddUser extends Request {
    public function execute($params,$input) {
		...
		try {
			$requete = singleton::getInstance()->prepare("CALL add_user(:_last_name,:_first_name,:_email,:_password,:_img_path,:_address,:_user_pseudo,:_news_letter,:_age,:_id_city)");
			...
			$requete->bindValue(':_user_pseudo', $input['user_pseudo'], PDO::PARAM_INT);
			$requete->bindValue(':_age', $input['age'], PDO::PARAM_INT);
			$requete->bindValue(':_id_city', $input['id_city'], PDO::PARAM_INT);
